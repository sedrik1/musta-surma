    ...
    switch (layerName) {
        ...
        this.setState({
          displayElements: {
            ...
            disease: {
              ...
              displayDiseaseSpread_1346: !this.state.displayElements.disease
      ...
      case "Disease_v. 1347":
        this.setState({
          displayElements: {
            ...
            disease: {
              ...this.state.displayElements.disease,
              displayDiseaseSpread_1347: !this.state.displayElements.disease
      ...
      case "Disease_v. 1348":
        this.setState({
          displayElements: {
            ...
            disease: {
              ...this.state.displayElements.disease,
              displayDiseaseSpread_1348: !this.state.displayElements.disease
      ...
      case "Disease_v. 1349":
        this.setState({
          displayElements: {
            ...
            disease: {
              ...this.state.displayElements.disease,
              displayDiseaseSpread_1349: !this.state.displayElements.disease
      ...
      case "Disease_v. 1350":
        this.setState({
          displayElements: {
            ...
            disease: {
              ...this.state.displayElements.disease,
              displayDiseaseSpread_1350: !this.state.displayElements.disease
      ...
      case "Disease_v. 1351":
        this.setState({
          displayElements: {
            ...
            disease: {
              ...this.state.displayElements.disease,
              displayDiseaseSpread_1351: !this.state.displayElements.disease
      ...
      case "Disease_v. 1352":
        this.setState({
          displayElements: {
            ...
            disease: {
              ...this.state.displayElements.disease,
              displayDiseaseSpread_1352: !this.state.displayElements.disease
      ...
      case "Disease_v. 1353":
        this.setState({
          displayElements: {
            ...
            disease: {
              ...this.state.displayElements.disease,
              displayDiseaseSpread_1353: !this.state.displayElements.disease
        ...
        this.setState({
          displayElements: {
            ...
            cities: {
              ...
              displayMediterranean: !this.state.displayElements.cities
      ...
      case "MainlandEast":
        this.setState({
          displayElements: {
            ...
            cities: {
              ...this.state.displayElements.cities,
              displayMainlandEast: !this.state.displayElements.cities
                .displayMainlandEast,
            },
          },
        });
      ...
      case "MainlandWest":
        this.setState({
          displayElements: {
            ...
            cities: {
              ...this.state.displayElements.cities,
              displayMainlandWest: !this.state.displayElements.cities
                .displayMainlandWest,
            },
          },
        });
      ...
      case "NorthEurope":
        this.setState({
          displayElements: {
            ...
            cities: {
              ...this.state.displayElements.cities,
              displayNorthEurope: !this.state.displayElements.cities
                .displayNorthEurope,
            },
          },
        });
      ...
      case "Britain":
        this.setState({
          displayElements: {
            ...
            cities: {
              ...this.state.displayElements.cities,
              displayBritain: !this.state.displayElements.cities.displayBritain,
            },
          },
        });
        break;
      case "AllTerrains":
        this.setState({
          displayElements: {
            ...this.state.displayElements,
            displayAllTerrain: !this.state.displayElements.displayAllTerrain,
          },
        });
        break;
      case "Routes":
        this.setState({
          displayElements: {
            ...this.state.displayElements,
            displayRoutes: !this.state.displayElements.displayRoutes,
          },
        });
        break;
        ...
        this.setState({
          displayElements: {
            ...
            routes: {
              ...
              MediterraneanRoutes: !this.state.displayElements.routes
                .MediterraneanRoutes,
            },
          },
        });
      ...
      case "BritainRoutes":
        this.setState({
          displayElements: {
            ...
            routes: {
              ...this.state.displayElements.routes,
              BritainRoutes: !this.state.displayElements.routes.BritainRoutes,
            },
          },
        });
        break;
      ...
      case "NorthEuropeRoutes":
        this.setState({
          displayElements: {
            ...
            routes: {
              ...this.state.displayElements.routes,
              NorthEuropeRoutes: !this.state.displayElements.routes
                .NorthEuropeRoutes,
            },
          },
        });
      ...
      case "SpainRoutes":
        this.setState({
          displayElements: {
            ...
            routes: {
              ...this.state.displayElements.routes,
              SpainRoutes: !this.state.displayElements.routes.SpainRoutes,
            },
          },
        });
        break;
      case "GoldenHorde":
        this.setState({
          displayElements: {
            ...this.state.displayElements,
            displayGoldenHorde: !this.state.displayElements.displayGoldenHorde,
          },
        });
        break;
      default:
    ...
    let years = [
      {
        ...
        value: this.state.displayElements.disease.displayDiseaseSpread_1346,
      },
      {
        year: <V1347 key="V1347" />,
        value: this.state.displayElements.disease.displayDiseaseSpread_1347,
      },
      {
        year: <V1348 key="V1348" />,
        value: this.state.displayElements.disease.displayDiseaseSpread_1348,
      },
      {
        year: <V1349 key="V1349" />,
        value: this.state.displayElements.disease.displayDiseaseSpread_1349,
      },
      {
        year: <V1350 key="V1350" />,
        value: this.state.displayElements.disease.displayDiseaseSpread_1350,
      },
      {
        year: <V1351 key="V1351" />,
        value: this.state.displayElements.disease.displayDiseaseSpread_1351,
      },
      {
        year: <V1352 key="V1352" />,
        value: this.state.displayElements.disease.displayDiseaseSpread_1352,
      },
      {
        year: <V1353 key="V1353" />,
        value: this.state.displayElements.disease.displayDiseaseSpread_1353,
      },
    ];
        ...
        ({ coordinates, by, route }, index) => {
          return (
            <Curve
              key={index}
              positions={coordinates}
              option={by === "sea" ? seaRouteStyle : landRouteStyle}
            >
              <Popup>{route}</Popup>
            </Curve>
          );
    ...
    return (
      <>
        <SidebarContainer
          ...
          handleLayerControl={(layerName) => this.handleLayerControl(layerName)}
          handleSource={() => this.handleSource()}
        />

        <Map className="map-style" center={[56.1, 23.106111]} zoom={4}>
          <TileLayer
            attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors. Tiles &copy; Esri &mdash; Esri, DeLorme, NAVTEQ'
          ...
          <LayersControl position="bottomleft">
            {!this.state.displayElements.displayGoldenHorde ? (
              ...
              >
                <Popup>Kultaisen ordan raja (suunnilleen)</Popup>
              </Curve>
            )}
            ...
            {!this.state.displayElements.displayRoutes
              ? allRoutes.map(({ value, routes }) => (!value ? false : routes))
              : this.state.displayElements.displayRoutes
            ...
            {!this.state.displayElements.displayAllTerrain
              ? cities.map(({ City, value }) =>
                  !value ? (
                    ...
                    <FeatureGroup key={City.key} color="#000">
                      {City}
                    </FeatureGroup>
                  )
                )
