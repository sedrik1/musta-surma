...
const WestEurope = [
	...
	},
	{
		...
		Kunnan asukasluku on piirun verran yli 8000 henkilöä. San Gimignano menetti tutkimuksien mukaan 66 % väestöstään.
		Yksinkertaisella prosenttilaskulla, 8000 / 100 * 66, saadaan tulokseksi 5280. Pelkkä kuolinluku sellaisenaankin on suuri, mutta jos otetaan tarkastelukohteeksi synnyinluvut Suomessa vuonna 2019, voidaan asiaa tarkastella pelkistetysti syntymät-kuolemat-asetelmalla.
		Vuonna 2019 Suomessa elävänä syntyneitä oli 45 613. Toimittamalla laskusuorituksen 5280 * 100 / 45613 saadaan vastaukseksi n. 11,6 %. San Gimignanon koettelemus ei olisi siis nykypäivänkään kunnassa, saatikka valtiollisesti, pieni asia.`,
	},
	{
		reference: [],
